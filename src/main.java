...
public class main {
    public static void main(String[] args) {
        ...
        Object[] perfis = { "Admin", "Tecnico", "Usuario" };//nao mexer
        ...
        Object[] opcoesLogin;
        if (perfillogado.equals("Usuario")) {//nao mexer
            opcoesLogin = new Object[]{ "Logar", "Cadastrar Novo", "Sair" };//nao mexer
        } else {
            opcoesLogin = new Object[]{ "Logar", "Sair" };//nao mexer
        }
        ...
        if (acao != -1 && opcoesLogin[acao].equals("Cadastrar Novo")) {//nao mexer
        ...
        while (true) {
            String[] botoes;
            if (perfillogado.equals("Admin")) {//nao mexer
            ...
            } else if (perfillogado.equals("Tecnico")) {//nao mexer
